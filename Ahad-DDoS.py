...
if str(platform.system()) == 'Linux':
    os.system('figlet Anonymous Ahad DDoS Attack')
else:
    os.system('pyfiglet Anonymous Ahad DDoS Attack')

print(Back.GREEN + Fore.GREEN +'[+] Anonymous DDoS tool by' + Fore.RED + 'Team Mysterious Bangladesh                          ') 
print(Back.GREEN + Fore.BLACK + '[+]Ahad-DDoS Tool BETA VERSION 0.1                                             ')
print(Back.BLACK +Fore.GREEN + '[+] Ahad-DDoS Tool Interactive Menu in Python by Mohammad Ahad                         ')
print(Fore.YELLOW + '[+] We are Anonymous, We are a Legion, We do not Forgive, We do not Forget                            ')
print(Fore.GREEN + '[+] Starting Ahad DoS Tool with 1024 Baseline Threads as Default change below as Required           ')
print(Fore.BLUE + 'Author: ' + Fore.GREEN + 'Mohammad Ahad (UBISOFT-1)')
print(Fore.RED + 'Telegram: ' + Fore.GREEN + 'https://t.me/Ahad_Vau_King')
print(Fore.YELLOW + 'GitHub: ' + Fore.GREEN + 'https://github.com/AHAD-VAU-KING')
